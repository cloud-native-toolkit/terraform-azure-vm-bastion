...
Module that provisions vm bastion on Azure.
...
- Subnet - github.com/cloud-native-toolkit/terraform-azure-subnets
...
module "azure_vm_bastion" {
  source                      = "github.com/cloud-native-toolkit/terraform-azure-vm-bastion/"
